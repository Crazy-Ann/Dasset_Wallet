package com.dasset.wallet.base.activity;
...
import com.dasset.wallet.base.toolbar.listener.OnTitleEventListener;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void initializeToolbar(int toolbarColorId, int titleColorId, boolean isTitleClickable, String title, OnTitleEventListener onTitleEventListener) {
        initializeToolbar(toolbarColorId, false, Constant.View.DEFAULT_RESOURCE, null,
                          titleColorId, isTitleClickable, title, onTitleEventListener, Constant.View.DEFAULT_RESOURCE, null, null);
    }
    ...
    protected void initializeToolbar(int toolbarColorId, boolean hasLeftIconEvent, int leftIconId, OnLeftIconEventListener onLeftIconEventListener
            , int titleColorId, boolean isTitleClickable, int titleIconId, OnTitleEventListener onTitleEventListener
            , boolean hasRightIconEvent, int rightIconId, final OnRightIconEventListener onRightIconEventListener) {
        initializeToolbar(toolbarColorId, hasLeftIconEvent, leftIconId, onLeftIconEventListener,
    ...
    private void initializeToolbar(int toolbarColorId, boolean hasLeftIconEvent, int leftIconId, final OnLeftIconEventListener onLeftIconEventListener
            , boolean isShowTitle, int titleColorId, boolean isTitleClickable, String title, int titleIconId, final OnTitleEventListener onTitleEventListener
        ...
        if (inToolbar != null) {
            ...
            if (hasLeftIconEvent) {
                ...
                if (ivLeftIconEvent != null) {
                    ViewUtil.getInstance().setViewGone(ivLeftIconEvent);
                }
            }
            if (isShowTitle) {
                if (isTitleClickable) {
                    ...
                    if (ivTitle == null) {
                        ivTitle = ViewUtil.getInstance().findViewAttachOnclick(inToolbar, R.id.ivTitle, new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                onTitleEventListener.onTitletEvent();
                            }
                    ...
                    if (ivTitle == null) {
                        ivTitle = ViewUtil.getInstance().findView(inToolbar, R.id.ivTitle);
                    }
                }
                ...
                } else if (titleIconId != Constant.View.DEFAULT_RESOURCE) {
                    GlideUtil.getInstance().with(this, titleIconId, ViewUtil.getInstance().dp2px(this, 96), ViewUtil.getInstance().dp2px(this, 24), DiskCacheStrategy.NONE, ivTitle);
                    ViewUtil.getInstance().setViewVisible(ivTitle);
                }
            } else {
                if (tvTitle != null) {
                    ViewUtil.getInstance().setViewGone(tvTitle);
                    ViewUtil.getInstance().setViewGone(ivTitle);
            ...
            if (hasRightTextEvent) {
                ...
                if (tvRightTextEvent != null) {
                    ViewUtil.getInstance().setViewGone(tvRightTextEvent);
                    tvRightTextEvent.setText(null);
                }
            }
            if (hasRightIconEvent) {
                if (ivRightIconEvent == null) {
                    ivRightIconEvent = ViewUtil.getInstance().findViewAttachOnclick(inToolbar, com.dasset.wallet.base.R.id.ivRightIconEvent, new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                ...
                if (ivRightIconEvent != null) {
                    ViewUtil.getInstance().setViewGone(ivRightIconEvent);
                }
            }
        }
    }
...
//        super.onBackPressed();
    ...
    public void onFinish(String message) {
        super.finish();
        overridePendingTransition(com.dasset.wallet.base.R.anim.slide_left_in, com.dasset.wallet.base.R.anim.slide_right_out);
