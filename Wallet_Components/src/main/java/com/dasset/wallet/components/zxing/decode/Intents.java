...
public final class Intents {
    ...
    public static final class Encode {
         ...
         * Bundle, depending on the mediaType and format specified. Non-QR Code formats should
         * just use a String here. For QR Code, see Contents for details.
         */
        public static final String DATA = "ENCODE_DATA";

        /**
         * The mediaType of data being supplied if the format is QR Code. Use
         * Intent.putExtra(TYPE, mediaType) with one of Contents.Type.
         */
