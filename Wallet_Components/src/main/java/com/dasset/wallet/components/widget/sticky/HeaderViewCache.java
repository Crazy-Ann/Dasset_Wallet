...
public class HeaderViewCache implements HeaderProvider {
    ...
    public View getHeader(RecyclerView parent, int position) {
        ...
        if (header == null) {
            //TODO - recycle views
            RecyclerView.ViewHolder viewHolder = stickyRecyclerHeadersAdapter.onCreateHeaderViewHolder(parent);
            stickyRecyclerHeadersAdapter.onBindHeaderViewHolder(viewHolder, position);
            ...
            if (orientationProvider.getOrientation(parent) == LinearLayoutManager.VERTICAL) {
