...
public class Bip38 {
     ...
     */
    public static String encryptNoEcMultiply(String passphrase, String base58EncodedPrivateKey, SCryptProgress progressTracker) throws InterruptedException, AddressFormatException {
     ...
     * @throws InterruptedException
     */
    public static String decrypt(String bip38PrivateKeyString, String passphrase, SCryptProgress progressTracker, NetworkParameters network) throws InterruptedException, AddressFormatException {
