...
public final class ECSignatureFactory {
    ...
    private static ECSignatureFactory eCSignatureFactory;
    ...
    public static synchronized ECSignatureFactory getInstance() {
        if (eCSignatureFactory == null) {
            eCSignatureFactory = new ECSignatureFactory();
        }
