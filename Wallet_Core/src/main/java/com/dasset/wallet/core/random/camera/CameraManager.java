package com.dasset.wallet.core.random.camera;
...
public final class CameraManager {
    ...
    public Camera open(final SurfaceHolder surfaceHolder, final boolean continuousAutoFocus) throws IOException {
        ...
        final int rawSize = Math.min(surfaceWidth * 4 / 5, surfaceHeight * 4 / 5);
        ...
        this.framePreview = new Rect(frame.left * cameraResolution.height / surfaceWidth, frame.top * cameraResolution.width / surfaceHeight, frame.right * cameraResolution.height / surfaceWidth, frame.bottom * cameraResolution.width / surfaceHeight);
        ...
        try {
            ...
            if (savedParameters != null) {
                ...
                cameraParameters.unflatten(savedParameters);
                try {
    ...
    private static final Comparator<Camera.Size> COMPARATOR = new Comparator<Camera.Size>() {
    ...
    private static Camera.Size findBestPreviewSizeValue(final Camera.Parameters parameters, Rect surfaceResolution) {
        ...
        final List<Camera.Size> supportedPreviewSizes = Lists.newArrayList(rawSupportedSizes);
