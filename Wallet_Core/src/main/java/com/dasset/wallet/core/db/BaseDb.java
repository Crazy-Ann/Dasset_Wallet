...
public abstract class BaseDb {
    ...
    public static final String CREATE_ADDRESSTXS_SQL = "create table if not exists addresses_txs(address text not null" +
            ", tx_hash text not null" +
            ", primary key(address, tx_hash));";
    public static final String CREATE_TXS_SQL = "create table if not exists txs(tx_hash text primary key" +
            ", tx_ver integer" +
            ", tx_locktime integer" +
            ", tx_time integer" +
            ", block_no integer" +
    ...
    // new index
    public static final String CREATE_OUT_ADDRESS_INDEX = "create index idx_out_address on outs(out_address);";
    ...
    public static final String CREATE_ENTERPRISE_HD_ACCOUNT = "create table if not exists enterprise_hd_account(hd_account_id integer not null primary key autoincrement" +
            ...
            ", hd_address text not null" +
            ", is_xrandom integer not null);";
    public static final String CREATE_MULTI_SIGN_SET = "create table if not exists enterprise_multi_sign_set(multi_sign_id integer not null primary key autoincrement" +
    ...
    public interface HDAccountAddressesColumns {
        ...
        public static final String ADDRESS = "address";
        public static final String PUB = "publicKey";
        public static final String IS_SYNCED = "is_synced";
    }
